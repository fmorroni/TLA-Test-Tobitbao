...
#elif defined(__GNU__) || defined(__gnu_linux__) || defined(__linux__) || defined(__linux) || defined(linux)
#define CRITICAL_COLOR "\033[0;31m"
#define DEBUGGING_COLOR "\033[0;35m"
#define DEFAULT_COLOR "\033[0m"
#define ERROR_COLOR "\033[1;31m"
#define INFORMATION_COLOR "\033[0;32m"
#define WARNING_COLOR "\033[0;33m"
#elif defined(__TOS_WIN__) || defined(__WIN32__) || defined(__WINDOWS__) || defined(_WIN16) || defined(_WIN32) ||      \
  defined(_WIN64)
